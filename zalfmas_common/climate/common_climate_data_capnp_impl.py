...
def gcm_to_info(gcm):
    if not hasattr(gcm_to_info, "d"):
        gcm_to_info.d = {
            climate_capnp.GCM.cccmaCanEsm2: {
                "id": "CCCma-CanESM2",
                "name": "CCCma-CanESM2",
                "description": "",
            },
            climate_capnp.GCM.ichecEcEarth: {
                "id": "ICHEC-EC-EARTH",
                "name": "ICHEC-EC-EARTH",
                "description": "",
            },
            climate_capnp.GCM.ipslIpslCm5AMr: {
                "id": "IPSL-IPSL-CM5A-MR",
                "name": "IPSL-IPSL-CM5A-MR",
                "description": "",
            },
            climate_capnp.GCM.mirocMiroc5: {
                "id": "MIROC-MIROC5",
                "name": "MIROC-MIROC5",
                "description": "",
            },
            climate_capnp.GCM.mpiMMpiEsmLr: {
                "id": "MPI-M-MPI-ESM-LR",
                "name": "MPI-M-MPI-ESM-LR",
                "description": "",
            },
            climate_capnp.GCM.gfdlEsm4: {
                "id": "GFDL-ESM4",
                "name": "GFDL-ESM4",
                "description": "",
            },
            climate_capnp.GCM.ipslCm6aLr: {
                "id": "IPSL-CM6A-LR",
                "name": "IPSL-CM6A-LR",
                "description": "",
            },
            climate_capnp.GCM.mpiEsm12Hr: {
                "id": "MPI-ESM1-2-HR",
                "name": "MPI-ESM1-2-HR",
                "description": "",
            },
            climate_capnp.GCM.mriEsm20: {
                "id": "MRI-ESM2-0",
                "name": "MRI-ESM2-0",
                "description": "",
            },
            climate_capnp.GCM.ukesm10Ll: {
                "id": "UKESM1-0-LL",
                "name": "UKESM1-0-LL",
                "description": "",
            },
            climate_capnp.GCM.mohcHadGem2Es: {
                "id": "MOHC-HadGEM2-ES",
...
def rcm_to_info(rcm):
    if not hasattr(rcm_to_info, "d"):
        rcm_to_info.d = {
            climate_capnp.RCM.clmcomCclm4817: {
                "id": "CLMcom-CCLM4-8-17",
                "name": "CLMcom-CCLM4-8-17",
                "description": "",
            },
            climate_capnp.RCM.gericsRemo2015: {
                "id": "GERICS-REMO2015",
                "name": "GERICS-REMO2015",
                "description": "",
            },
            climate_capnp.RCM.knmiRacmo22E: {
                "id": "KNMI-RACMO22E",
                "name": "KNMI-RACMO22E",
                "description": "",
            },
            climate_capnp.RCM.smhiRca4: {
                "id": "SMHI-RCA4",
                "name": "SMHI-RCA4",
                "description": "",
            },
            climate_capnp.RCM.clmcomBtuCclm4817: {
                "id": "CLMcom-BTU-CCLM4-8-17",
                "name": "CLMcom-BTU-CCLM4-8-17",
                "description": "",
            },
            climate_capnp.RCM.mpiCscRemo2009: {
                "id": "MPI-CSC-REMO2009",
                "name": "MPI-CSC-REMO2009",
                "description": "",
            },
            climate_capnp.RCM.uhohWrf361H: {
                "id": "UHOH-WRF361H",
                "name": "UHOH-WRF361H",
                "description": "",
            },
...
def ensmem_to_info(ensmem):
    # r<N>i<M>p<L>f<F>
    id = f"r{ensmem.r}i{ensmem.i}p{ensmem.p}"
    description = f"Realization: #{ensmem.r}, Initialization: #{ensmem.i}, Pertubation: #{ensmem.p}"
    if ensmem.f > 0:
        id = id + f"f{ensmem.f}"
        description = description + f", Forcing: #{ensmem.f}"
...
class MetadataInfo(climate_capnp.Metadata.Information.Server):
    def __init__(self, metadata):
        ...
        self._entry_to_info = {
            ...
            "start": lambda v: {
                "id": create_date(v).isoformat()[:10],
                "name": create_date(v).isoformat()[:10],
                "description": "",
            },
            "end": lambda v: {
                "id": create_date(v).isoformat()[:10],
...
class Service(
    ...
    async def getDatasetsFor(
        self, template, **kwargs
    ):  # getDatasets @1 (template :Metadata) -> (datasets :List(Dataset));
